...
<html>
<head>
	<title>답변글 입력하기</title>
</head>
<body>
	<h2>답변글 입력하기</h2>
	<%
		//게시글 읽기 페이지에서 답변 글쓰기 버튼을 클릭하면 넘겨주는 데이터들을 받는다.
		int num = Integer.parseInt(request.getParameter("num"));// 어떤 게시물이 알기 위해서
	...
	<form action="BoardReWriteProc.jsp" method="post">
		<table width="600" border="1" bordercolor="gray" bgcolor="skyblue">
			...
			<!--  form에서 사용자로부터 입력받지 않고 데이터를 넘겨주는 방법 -->
			<tr height="40">
				<td align="center" colspan="2">
					<input type="hidden" name="ref" value="<%=ref %>"> 
					<input type="hidden" name="re_step" value="<%=re_step %>">
					<input type="hidden" name="re_level" value="<%=re_level %>">
					<input type="submit" value="답변 글쓰기완료">&nbsp;&nbsp;
